...
def get_zillow_data():
    ...
    '''
    if isfile('data/raw_zillow.csv'):
        df = query_sql()
        print('CSV already generated, getting data from "data" directory')
    else:
        df = query_sql()
        df.to_csv('data/raw_zillow.csv')
        print('Generated CSV generated, extracting data from CSV')
